...
@endsection
    <div style="min-height: 440px;" class="page-content">
        ...
        @if($helpdeskCommentData['items'][0]['crmFeeds']['status'] == 2)
        <div class="row">
          <div class="col-md-4">
            <div class="alert alert-block alert-danger fade in">
              <center>
                  Are you satisfied with the solution?
                <form action="/helpdesk/ticket/changestatus" method="post"  class="form-horizontal">
                  <input type="hidden" value="{{$helpdesk_id}}" id="helpdesk_id" name="helpdesk_id">
                  <input type="hidden" name="status" value="1">
                  <input class="btn btn-circle green" type="submit" value="Yes">
                </form>

                <form action="/helpdesk/ticket/changestatus" method="post"  class="form-horizontal">
                  <input type="hidden" value="{{$helpdesk_id}}" id="helpdesk_id" name="helpdesk_id">
                  <input type="hidden" name="status" value="0">
                  <input class="btn btn-circle purple" type="submit" value="No">
                </form>
              </center>
            </div>
          </div>
        </div>
          @elseif($helpdeskCommentData['items'][0]['crmFeeds']['status'] == 1)
          <div class="row">
            <div class="col-md-4">
          ...
          @else($helpdeskCommentData['items'][0]['crmFeeds']['status'] == 0)
          @endif
                            ...
                            <div class="mt-list-container list-default">
                                <div class="portlet-body" id="chats">
                                    <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                      ...
                                      <form action="/helpdesk/ticket/comment/{{$helpdesk_id}}" method="post"  class="form-horizontal">
                                        <input type="hidden" value="{{$helpdesk_id}}" id="helpdeskid" name="helpdeskid">
                                        <div class="form-group input-cont">
                                             <textarea id="content" class="wysihtml5 form-control" rows="6" name="commented" placeholder="Type a message here..."  type="text" required></textarea>
                                        </div>
                                         <div class="form-group">
                                           <input name="submit" value="Comment" class="btn blue icn-only" type="submit">
                                         </div>
                                    </form>
                                    @elseif($helpdeskCommentData['items'][0]['crmFeeds']['status'] == 2)
                                    <form action="/helpdesk/ticket/comment/{{$helpdesk_id}}" method="post"  class="form-horizontal">
                                      <input type="hidden" value="{{$helpdesk_id}}" id="helpdeskid" name="helpdeskid">
                                      <div class="form-group input-cont">
                                           <textarea id="content" class="wysihtml5 form-control" rows="6" name="commented" placeholder="Type a message here..."  type="text" required></textarea>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="createCompanyForm" action="/helpdesk/ticket/add" method="post"  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <select id="add-users" class="form-control select2-multiple" multiple name="userID[]" data-placeholder="Add Users">
                                    @foreach($usersData['items'] as $user)
                                        <option value="{{$user['userid']}}">{{ $user['unitname'] }}</option>
                                    @endforeach
                                </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-actions-wrapper">
                        <form name="createCompanyForm" action="/helpdesk/ticket/removeusers/{{$helpdesk_id}}" method="post"  class="form-horizontal">
