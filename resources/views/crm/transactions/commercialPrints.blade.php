...
@section("content")
    ...
    <div style="min-height: 440px;" class="page-content" ng-controller="TransactionController" ng-init="names = <?php echo htmlspecialchars(json_encode($viewData[0])); ?>">
                                            ...
                                            <article class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="title" class="form-control" name="title"
                                                           placeholder="Title" type="text" value="" required ng-model="job_title"  ng-value="names.crmJobs.title">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input id="description" class="form-control" name="description"
                                                           placeholder="Description" type="text" value="{{old('description')}}" required ng-model="job_description" ng-value="names.crmJobs.description">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input id="instruction" class="form-control" name=instruction"
                                                           placeholder="Instruction" type="text" value="{{old('instruction')}}" required ng-model="job_instruction" ng-value="names.crmJobs.instruction">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input id="jobsize" class="form-control" name="jobsize"
                                                           placeholder="Job size" type="text" value="{{old('jobsize')}}" required ng-model="job_jobsize" ng-value="names.crmJobs.jobsize">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input id="spot_colour" class="form-control" name="spot_colour"
                                                           placeholder="Spot colour" type="text" value="{{old('spot_colour')}}" required ng-model="job_spot_colour" ng-value="names.crmJobs.spot_colour">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cymk" class="control-label">CYMK <span class="required"> * </span>: </label>
                                                    <input id="cymk" class="form-control" name="cymk"
                                                           placeholder="CYMK" type="text" value="{{old('cymk')}}" required ng-model="job_cymk" ng-value="names.crmJobs.cymk">
                                                </div>
                                            ...
                                            <article class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="client_as" class="form-control" name="client_as"
                                                           placeholder="Client as" value="{{old('client_as')}}" type="text" required ng-model="design_generation_client_as" ng-value="names.crmDesignGeneration.client_as">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input id="design_others" class="form-control" name="design_others"
                                                           placeholder="Others" type="text" value="{{old('design_others')}}" required ng-model="design_generation_design_others" ng-value="names.crmDesignGeneration.design_others">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <article class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <input id="name" class="form-control" name="pantone"
                                                                   value="{{old('pantone')}}" placeholder="Colours (Multiple should be separated by a comma)" type="text" required ng-model="logo_colour_pantone" ng-value="names.crmLogoColors.pantone" ng-value="names.crmDesignGeneration.pantone">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="supplied_digit_as" id="supplied_digit_as"
                                                           placeholder="Supplied Digit As" value="{{old('supplied_digit_as')}}" type="text" required ng-model="logo_colour_supplied_digit_as" ng-value="names.crmLogoColors.supplied_digit_as">
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-4">
                                                            ...
                                                            <input id="start_date_to_studio" readonly class="form-control form_datetime" name="start_date_to_studio"
                                                                ...
                                                                Studio" type="text" value="{{old('start_date_to_studio')}}" required ng-model="proof_generation_start_date_to_studio" ng-value="names.crmLogoColors.supplied_digit_as">
                                                        </div>
                                                        <div class="col-xs-4">
                                                            <label for="receive_by" class="control-label">Received by
                                                                <span class="required"> * </span>: </label>
                                                            <input id="receive_by" class="form-control" name="receive_by"
                                                                   placeholder="Received by" value="{{old('receive_by')}}" type="text" required ng-model="proof_generation_receive_by" ng-value="names.crmProofGenerationTime.receive_by">
                                                        </div>
                                                        <div class="col-xs-4">
                                                            ...
                                                            <input id="receive_by_date" readonly class="form-control form_datetime" name="receive_by_date"
                                                                   placeholder="Date" type="text" value="{{old('receive_by_date')}}" required ng-model="proof_generation_receive_by_date" ng-value="names.crmProofGenerationTime.receive_by_date">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            ...
                                                            <input readonly id="agreed_date_time" class="form-control form_datetime" name="agreed_date_time"
                                                                   placeholder="Agreed Target Time" value="{{old('agreed_date_time')}}" type="text" required ng-model="proof_generation_agreed_date_time" ng-value="names.crmProofGenerationTime.agreed_date_time">
                                                        </div>
                                                        <div class="col-xs-6">
                                                            ...
                                                            <input id="ended" readonly class="form-control form_datetime" name="ended" placeholder="End Time" type="text"
                                                                   required value="{{old('ended')}}" ng-model="proof_generation_ended" ng-value="names.crmProofGenerationTime.ended">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
