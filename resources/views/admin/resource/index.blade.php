...
@section("content")
        ...
        <div class="page-content-container">
            <div class="page-content-row">
                ...
                <div class="page-content-col">
                  <a href="javascript:void(0);" class="btn btn-primary showCreateResourceModal"><i class="fa fa-bus"></i> Create Application</a>
                  <br/><br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" cellspacing="0">
                            ...
                            $serial=1;
                            ?>
                            @foreach($viewData['items'] as $app)
                                <tr>
                                    <td>{{$serial}}</td>
                                    <td>{{$app['key']}}</td>
                                    <td>{{$app['application_id']}}</td>
                                    <td class="actions">
                                        <a href="javascript:void(0);" class="btn btn-info edit-resource" data-id="{{$app['id']}}"
                                        data-name="{{$app['key']}}"
                                        data-description="{{$app['application_id']}}"><i class="fa fa-edit"></i> Edit</a>
    ...
    <section id="createResourceModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="createResourceForm" action="/admin/createapp" method="post" novalidate class="form-horizontal">
                        <article class="col-md-12">
                            <div class="form-group">
                                <label for="purpose" class="control-label">Application Key:</label>
                                <input id="purpose" class="form-control"  name="purpose"
                                     placeholder="Enter Application Name" required>
                            </div>
                            <div class="form-group">
                                <label for="details" class="control-label">Select Application:</label>
